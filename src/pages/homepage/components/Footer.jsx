          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-semibold font-heading">Developer Bikash</span>
              </div>
              <p className="text-secondary-300 mb-6 leading-relaxed">
                Your trusted real estate development partner. Creating innovative property solutions 
                and connecting communities through exceptional development projects.
              </p>
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex items-center space-x-2 text-secondary-300">
                  ...
                  <span>info@developerbikash.com</span>
                </div>
                <div className="flex items-center space-x-2 text-secondary-300">
                  <Icon name="Globe" size={16} />
                  <a 
                    href="https://developerbikash.com" 
                    target="_blank" 
        ...
        <div className="py-6 border-t border-secondary-600">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-secondary-300 text-sm mb-4 md:mb-0">
              © {currentYear} Developer Bikash. All rights reserved.
            </div>
